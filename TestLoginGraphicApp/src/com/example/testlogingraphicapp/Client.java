...
public class Client {
	...
	public static boolean deleteDesires(DeletePack delPack){
		return clientRunnable.deleteDesires(delPack);
	}
	...
	private static class ClientRunnable implements Runnable{
		...
		public boolean sendDesire(DesireContent newContent) throws Exception{
		...
		public boolean deleteDesires(DeletePack delPack){
			try {
